                ...
                <div className="row margin-t-30">
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30 hover-effect">
                            <img src="../../static/landing-page/images/blog/img-1.jpg" className="img-fluid" alt="" />
                            <div>
                                <h5 className="mt-4 text-muted">UI & UX Design</h5>
                                <h4 className="mt-3"><a href="JavaScript:Void(0);" className="blog-title"> Doing a cross country road trip </a></h4>
                                <p className="text-muted">She packed her seven versalia, put her initial into the belt and made herself on the way..</p>
                                <div className="mt-3">
                                    <a href="JavaScript:Void(0);" className="read-btn">Read More <i className="mdi mdi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30 hover-effect">
                            <img src="../../static/landing-page/images/blog/img-2.jpg" className="img-fluid" alt="" />
                            <div>
                                <h5 className="mt-4 text-muted">Digital Marketing</h5>
                                <h4 className="mt-3"><a href="JavaScript:Void(0);" className="blog-title">New exhibition at our Museum</a></h4>
                    ...
                    <div className="col-lg-4">
                        <div className="blog-box margin-t-30 hover-effect">
                            <img src="../../static/landing-page/images/blog/img-3.jpg" className="img-fluid" alt="" />
                            <div>
                                <h5 className="mt-4 text-muted">Travelling</h5>
                                <h4 className="mt-3"><a href="JavaScript:Void(0);"className="blog-title">Why are so many people..</a></h4>
