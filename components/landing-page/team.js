                ...
                <div className="row margin-t-50">
                        ...
                        <div className="team-box text-center hover-effect">
                            <div className="team-wrapper">
                                <div className="team-member">
                                    <img alt="" src="../../static/landing-page/images/team/img-1.jpg" className="img-fluid rounded" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="team-box text-center hover-effect">
                            <div className="team-wrapper">
                                <div className="team-member">
                                    <img alt="" src="../../static/landing-page/images/team/img-2.jpg" className="img-fluid rounded" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="team-box text-center hover-effect">
                            <div className="team-wrapper">
                                <div className="team-member">
                                    <img alt="" src="../../static/landing-page/images/team/img-3.jpg" className="img-fluid rounded" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="team-box text-center hover-effect">
                            <div className="team-wrapper">
                                <div className="team-member">
                                    <img alt="" src="../../static/landing-page/images/team/img-4.jpg" className="img-fluid rounded" />
                                </div>
                            </div>
